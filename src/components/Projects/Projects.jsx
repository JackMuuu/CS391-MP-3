                ...
                <div className={styles.calWrap}>
                    <div className={styles.row}>
                        ...
                        <button className={styles.button} onClick={multiply}>
                            <img src="/multiply.png" alt="multiply" className={styles.icon} />
                        </button>
                        <button className={styles.button} onClick={power}>
                            <img src="/power.png" alt="power" className={styles.icon} />
                        </button>
                    </div>
                    ...
                    <div className={styles.row}>
                        ...
                        <button className={styles.button} onClick={minus}>
                            <img src="/minus.png" alt="minus" className={styles.icon} />
                        </button>
                        <button className={styles.button} onClick={divide}>
                            <img src="/divide.png" alt="divide" className={styles.icon} />
                        </button>
                        <button className={styles.button} onClick={clearFunction}>
                            <img src="/clear.png" alt="clear" className={styles.icon} />
                        </button>
                    </div>
